...
import dateCompents from './dateCompents';
...
　sumFunction.install = Vue => Vue.component(dateCompents.name, dateCompents);//注册组件


// 标签的方式引入，留到后面再另开新篇讨论
//   const install = function(Vue, opts = {}) {
// 　　　Vue.component(dateCompents.name, dateCompents);
// 　}
